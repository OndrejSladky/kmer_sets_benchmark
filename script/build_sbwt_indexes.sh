...
/usr/bin/time -v -a -o $results_filename_prefix-build.time.log ./sbwt_build/bin/sbwt build -i /mnt/hd2/pibiri/DNA/eulertigs/ncbi-virus.k31.eulertigs.fa.gz -k 31 -m 16 -t 64 -d /mnt/hd2/pibiri/DNA/tmp_dir/ --verbose -o /mnt/hd2/pibiri/DNA/sbwt-indexes/ncbi-virus.k31.sbwt
/usr/bin/time -v -a -o $results_filename_prefix-build.time.log ./sbwt_build/bin/sbwt build -i /mnt/hd2/pibiri/DNA/eulertigs/ncbi-virus.k31.eulertigs.fa.gz -k 31 -m 16 -t 64 -d /mnt/hd2/pibiri/DNA/tmp_dir/ --add-reverse-complements --verbose -o /mnt/hd2/pibiri/DNA/sbwt-indexes/ncbi-virus.k31.rc.sbwt
