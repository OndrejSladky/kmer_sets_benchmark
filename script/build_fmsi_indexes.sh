...
/usr/bin/time -v -a -o $results_filename_prefix-build.time.log fmsi index -k 31 /mnt/hd2/pibiri/DNA/masked-superstrings/cod.k31.msfa
...
/usr/bin/time -v -a -o $results_filename_prefix-build.time.log fmsi index -k 31 /mnt/hd2/pibiri/DNA/masked-superstrings/kestrel.k31.msfa
...
/usr/bin/time -v -a -o $results_filename_prefix-build.time.log fmsi index -k 31 /mnt/hd2/pibiri/DNA/masked-superstrings/human.k31.msfa
...
/usr/bin/time -v -a -o $results_filename_prefix-build.time.log fmsi index -k 31 /mnt/hd2/pibiri/DNA/masked-superstrings/ncbi-virus.k31.msfa
...
/usr/bin/time -v -a -o $results_filename_prefix-build.time.log fmsi index -k 31 /mnt/hd2/pibiri/DNA/masked-superstrings/se.k31.msfa
...
/usr/bin/time -v -a -o $results_filename_prefix-build.time.log fmsi index -k 31 /mnt/hd2/pibiri/DNA/masked-superstrings/hprc.k31.msfa
